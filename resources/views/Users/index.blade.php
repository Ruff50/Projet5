...
<div class="text-2xl text-left text-gray-700 mt-20 ml-10 mr-10 mb-10">Welcome <b>{{Auth::user()->name}},</b></div>

@endif
<div class="flex">
    <table class="w-full mb-14 ml-10 mr-10">
      <thead class="h-12">
        <tr>
          <th class="text-white bg-gray-600">
            Prénom  Nom</th>
            <th
