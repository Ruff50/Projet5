...
<div class="bg-white shadow rounded-lg mb-6">
    <div class="flex flex-row px-2 py-3 mx-3">
        <div class="w-auto h-auto rounded-full">
            <img class="w-12 h-12 object-cover rounded-full shadow cursor-pointer" alt="User avatar" src="{{asset('storage/' . $user->avatar)}}">
        </div>
    ...
    <div class="text-black p-4 antialiased flex">
        ...
        <div>
            <div class="bg-gray-100 rounded-lg px-4 pt-2 pb-2.5">
                ...
                <div class="text-xs leading-snug md:leading-normal"> k</div>
            </div>
