                                ...
                                <div class="bg-white shadow rounded-lg mb-6">
                                    ...
                                    <div class="text-gray-400 font-medium text-sm mb-7 mt-6 mx-3 px-2">
                                        ...
                                        <div class=" overflow-hidden rounded-xl col-span-3 h-[28rem] w-full ">
                                            <img class="rounded w-auto h-auto " src="/storage/{{ $post->photo }}"
                                                alt="">
                                        </div>
                                    ...
                                    <div class="text-gray-500 text-sm mb-6 mx-3 px-2">{{ $post->contenu }}<span
                                            class="text-gray-400">more</span></div>
                                    ...
                                    <div class="flex w-full border-t border-gray-100">
                                        ...
                                        <div class="mt-3 mx-5 w-full flex justify-end text-xs">
                                            <div class="flex text-gray-700  rounded-md mb-2 mr-4 items-center">Likes:
                                    ...
                                    <div
                                        ...
                                        <img class="w-10 h-10 object-cover rounded-full shadow mr-2 cursor-pointer"
                                            alt="User avatar" src="/storage/{{ $user->avatar }}">
                                        ...
                                        <form action="/comment" method="POST" enctype="multipart/form-data">
                                            ...
                                            <input type="search"
                                                ...
                                                style="border-radius: 25px" placeholder="Ajouter un commentaire..."
