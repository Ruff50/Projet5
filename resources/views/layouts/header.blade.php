        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          @guest
           ...
           @endguest    
            ...
            <a href="{{route('Users.index')}}" class="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700"> posts </a>
            @endauth
